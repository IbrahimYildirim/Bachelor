 ...
 */
  ...
  ***************************************************************************/
  ...
  'post /facebookLogin': 'AuthController.login',
  'post /register': 'AuthController.register',
  'post /facebook': 'AuthController.register',
  'post /sport' : 'SportController.addSportsForLoggedUser',
  'get /user/profile': 'UserController.getProfile',
  'post /user/uploadImage' : 'UserController.uploadProfileImage',
  'put /user' : 'UserController.updateProfile',
  'get /event/myEvents' : 'EventController.myEvents',
  'post /event/invite' : 'EventController.invite',
